<table {include file="editors/editor_options.tpl" Editor=$MultilevelEditor} class="pgui-multilvevel-autocomplete">
<tbody>
        ...
        <td>
            <input
                ...
                {if $Editor->getParentEditor()}
                    data-parent-autocomplete="{$Editor->getParentEditor()}"
                {/if}
