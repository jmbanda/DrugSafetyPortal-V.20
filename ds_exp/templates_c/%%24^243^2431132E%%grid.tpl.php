...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php if (! $this->_tpl_vars['Grid']['ErrorMessage'] == ''): ?>
        <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'common/message.tpl', 'smarty_include_vars' => array('type' => 'danger','dismissable' => true,'caption' => $this->_tpl_vars['Captions']->GetMessageString('ErrorsDuringUpdateProcess'),'content' => $this->_tpl_vars['Grid']['ErrorMessage'],'displayTime' => $this->_tpl_vars['Grid']['MessageDisplayTime'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php endif; ?>
    ...
    <?php if (! $this->_tpl_vars['Grid']['Message'] == ''): ?>
        <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'common/message.tpl', 'smarty_include_vars' => array('type' => 'success','dismissable' => true,'content' => $this->_tpl_vars['Grid']['Message'],'displayTime' => $this->_tpl_vars['Grid']['MessageDisplayTime'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php endif; ?>
