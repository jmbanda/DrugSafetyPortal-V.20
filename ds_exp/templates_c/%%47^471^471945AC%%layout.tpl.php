...
<body<?php if ($this->_tpl_vars['Page']): ?> id="pgpage-<?php echo $this->_tpl_vars['Page']->GetPageName(); ?>
"<?php endif; ?><?php if ($this->_tpl_vars['SideBar'] && ! $this->_tpl_vars['HideSideBarByDefault']): ?>class="sidebar-desktop-active"<?php endif; ?>>
...
<?php else: ?>col-md-12<?php endif; ?>">
            <?php if ($this->_tpl_vars['SideBar']): ?><div class="sidebar-outer"><?php endif; ?>
                <div class="container-padding">
                    ...
                    <hr>
                    <footer><?php echo $this->_tpl_vars['common']->getFooter(); ?>
</footer>
                </div>
